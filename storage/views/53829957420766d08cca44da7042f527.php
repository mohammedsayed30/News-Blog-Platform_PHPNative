    ...
    <div class="row">
        <div class="col-md-12">
            <div class="form-group">
                ...
                <input type="text" id="title" name="title" placeholder="<?php echo  trans('news.title')  ; ?> " class="form-control <?php echo  !empty(get_error('title'))?'is-invalid':''  ; ?>  " value="<?php echo $news['title'] ; ?> "/>
            </div>
        </div>
        ...
        <div class="col-md-12">
            <div class="form-group">
                ...
                <input type="content" id="content" name="content" placeholder="<?php echo trans('news.content') ; ?> " class="form-control <?php echo  !empty(get_error('content'))?'is-invalid':''  ; ?>  " value="<?php echo  $news['content']  ; ?> "/>
            </div>
        </div>
        <div class="col-md-12">
            <div class="form-group">
                <label for="description"><?php echo  trans('news.description')  ; ?> </label>
                <textarea name="description" id="description" placeholder="<?php echo trans('news.description') ; ?> " class="form-control <?php echo  !empty(get_error('description'))?'is-invalid':''  ; ?>  "><?php echo  $news['description']  ; ?> </textarea>
            </div>
        </div>
    </div>
