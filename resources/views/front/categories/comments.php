              ...
              <div class="col-md-7">
                ...
                <div class="card">
                  ...
                  <div class="mt-3 d-flex flex-row align-items-center p-3 form-color">
                    <input type="text" name="name" class="form-control" placeholder="{{trans('main.name')}}"></input>
                    <input type="email" name="email" class="form-control" placeholder="{{trans('main.email')}}"></input>
                  </div>
                  <div class="mt-3 d-flex flex-row align-items-center p-3 form-color">
                    <img src="https://placehold.co/400" width="50" class="rounded-circle ms-2
">
                    <textarea type="text" name="comment" class="form-control" placeholder="{{trans('main.write_comment')}}"></textarea>
                  </div>
                  <button class="btn btn-success add_comment" type="button">{{ trans('main.add_comment') }}</button>
